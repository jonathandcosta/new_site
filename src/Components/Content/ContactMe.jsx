    ...
    <section className="container">
      ...
      <div className={style.card}>
        ...
        <p className={style.description1}>
          ...
          website's results and experience, I can help. Let's work together! I
          offer complete consultancy for your e-commerce, covering all fronts of
          action, from the development and implementation of functionalities to
          the optimization of processes and sales strategies.
        </p>
      </div>
      <div className={style.card}>
        <p className={style.titulo}>
        ...
        <p className={style.description1}>
          ...
          enhance campaigns, always working collaboratively with design teams. I
          also perform website maintenance, integrating payment systems,
          databases and ERP, ensuring that all operations work seamlessly and
          securely.
        </p>
      </div>
      <div>
